...
class SharedModuleInjector extends import0.NgModuleInjector<import1.SharedModule> {
  ...
  _SharedModule_6:import1.SharedModule;
  __LOCALE_ID_7:any;
  ...
  get _APP_ID_15():any {
    if ((this.__APP_ID_15 == (null as any))) { (this.__APP_ID_15 = import22._appIdRandomProviderFactory()); }
  ...
  get _EventManager_19():import14.EventManager {
    if ((this.__EventManager_19 == (null as any))) { (this.__EventManager_19 = new import14.EventManager(this._EVENT_MANAGER_PLUGINS_18,this.parent.get(import25.NgZone))); }
  ...
  get _RootRenderer_23():any {
    if ((this.__RootRenderer_23 == (null as any))) { (this.__RootRenderer_23 = import26._createConditionalRootRenderer(this._DomRootRenderer_22,this.parent.get(import26.NgProbeToken,(null as any)))); }
  ...
  createInternal():import1.SharedModule {
    ...
    this._SharedModule_6 = new import1.SharedModule();
    ...
    this._Testability_11 = new import10.Testability(this.parent.get(import25.NgZone));
    this._ApplicationRef__12 = new import11.ApplicationRef_(this.parent.get(import25.NgZone),this.parent.get(import27.Console),this,this._ErrorHandler_9,this,this._ApplicationInitStatus_10,this.parent.get(import10.TestabilityRegistry,(null as any)),this._Testability_11);
  ...
  getInternal(token:any,notFoundResult:any):any {
    ...
    if ((token === import1.SharedModule)) { return this._SharedModule_6; }
    if ((token === import28.LOCALE_ID)) { return this._LOCALE_ID_7; }
    if ((token === import8.NgLocalization)) { return this._NgLocalization_8; }
    if ((token === import29.ErrorHandler)) { return this._ErrorHandler_9; }
    ...
    if ((token === import30.DOCUMENT)) { return this._DOCUMENT_16; }
    ...
    if ((token === import31.AnimationDriver)) { return this._AnimationDriver_21; }
    if ((token === import16.DomRootRenderer)) { return this._DomRootRenderer_22; }
    if ((token === import32.RootRenderer)) { return this._RootRenderer_23; }
    if ((token === import17.DomSanitizer)) { return this._DomSanitizer_24; }
    if ((token === import33.Sanitizer)) { return this._Sanitizer_25; }
    ...
    if ((token === import36.TRANSLATIONS_FORMAT)) { return this._TRANSLATIONS_FORMAT_32; }
