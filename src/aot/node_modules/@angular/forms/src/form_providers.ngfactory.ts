...
class ReactiveFormsModuleInjector extends import0.NgModuleInjector<import1.ReactiveFormsModule> {
  ...
  __FormBuilder_2:import6.FormBuilder;
  ...
  get _FormBuilder_2():import6.FormBuilder {
    if ((this.__FormBuilder_2 == (null as any))) { (this.__FormBuilder_2 = new import6.FormBuilder()); }
  ...
  getInternal(token:any,notFoundResult:any):any {
    ...
    if ((token === import6.FormBuilder)) { return this._FormBuilder_2; }
    if ((token === import3.RadioControlRegistry)) { return this._RadioControlRegistry_3; }
    if ((token === import5.LOCALE_ID)) { return this._LOCALE_ID_4; }
    if ((token === import5.TRANSLATIONS_FORMAT)) { return this._TRANSLATIONS_FORMAT_5; }
    return notFoundResult;
  }
  destroyInternal():void {
  }
